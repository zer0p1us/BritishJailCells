...
(true, false, 3, true, true),   -- Nottingham
(true, false, 2, false, false), -- London
(true, true, 4, true, true),    -- Manchester
(true, false, 1, false, false), -- Edinburgh
(false, true, 2, true, true),   -- Bristol
-- Additional Room Details
(true, false, 2, true, false),  -- Leeds
(true, true, 3, true, true),    -- Birmingham
(false, false, 1, false, false), -- Glasgow
(true, false, 4, true, true),    -- Cardiff
(true, true, 2, true, false),    -- Sheffield
(false, false, 3, false, true),  -- Newcastle
(true, false, 2, true, false);   -- Liverpool
